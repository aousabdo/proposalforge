...
┌─────────┐                 ┌──────────┐                 ┌───────┐
│         │                 │          │                 │       │
│ Browser │─── Register ───►│ Frontend │─── Register ───►│ Clerk │
│         │                 │          │                 │       │
└─────────┘                 └──────────┘                 └───┬───┘
                                                             │
                                                             │
...
┌─────────┐                 ┌──────────┐                 ┌───────┐
│         │                 │          │                 │       │
│ Browser │◄── Redirect ────│ Frontend │◄── Success ─────│ Clerk │
│         │                 │          │                 │       │
└─────────┘                 └──────────┘                 └───────┘
     │
     │
...
┌─────────┐                 ┌──────────┐                 ┌────────────┐
│         │                 │          │                 │            │
│ Browser │─── Create User ►│ Frontend │─── Create User ►│ ProposalForge │
│         │                 │          │                 │   API      │
└─────────┘                 └──────────┘                 └────────────┘
``` -->
...
┌─────────┐                 ┌──────────┐                 ┌───────┐
│         │                 │          │                 │       │
│ Browser │─── Login ──────►│ Frontend │─── Login ──────►│ Clerk │
│         │                 │          │                 │       │
└─────────┘                 └──────────┘                 └───┬───┘
                                                             │
                                                             │
...
┌─────────┐                 ┌──────────┐                 ┌───────┐
│         │                 │          │                 │       │
│ Browser │◄── JWT Token ───│ Frontend │◄── JWT Token ───│ Clerk │
│         │                 │          │                 │       │
└─────────┘                 └──────────┘                 └───────┘
     │
     │
...
┌─────────┐                 ┌──────────┐                 ┌────────────┐
│         │                 │          │                 │            │
│ Browser │─── API Request ►│ Frontend │─── API Request ►│ ProposalForge │
│         │   with Token    │          │   with Token    │   API      │
└─────────┘                 └──────────┘                 └────────────┘
``` -->

### Multi-Factor Authentication (Enterprise)

![MFA Flow](./images/mfa_flow.png)
...
┌─────────┐                 ┌──────────┐                 ┌───────┐
│         │                 │          │                 │       │
│ Browser │◄── MFA Prompt ──│ Frontend │◄── MFA Prompt ──│ Clerk │
│         │                 │          │                 │       │
└─────────┘                 └──────────┘                 └───────┘
     │
     │
...
┌─────────┐                 ┌──────────┐                 ┌───────┐
│         │                 │          │                 │       │
│ Browser │─── MFA Code ───►│ Frontend │─── MFA Code ───►│ Clerk │
│         │                 │          │                 │       │
└─────────┘                 └──────────┘                 └───┬───┘
                                                             │
                                                             │
